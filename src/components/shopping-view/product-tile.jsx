...
//   addToWishlist,
//   removeFromWishlist,
// } from "@/api/wishlistApi"; // ✅ Corrected import
// import { toast } from "react-toastify";
...
//         const updated = await fetchWishlist(); // Fetch updated list
//         setWishlistIds(updated.map((item) => item._id));
//         toast.success("Added to wishlist");
//       }
//     } catch (error) {
//       toast.error("Something went wrong while updating wishlist");
...
//       <CardFooter className="p-3 pt-1">
//         {availableQty <= 0 ? (
//           <Button disabled className="w-full text-sm opacity-60 cursor-not-allowed">
//             Out of Stock
//           </Button>
//         ) : (
//           <Button className="w-full text-sm" onClick={() => handleAddtoCart(product)}>
//             Add to Cart
//           </Button>
//         )}
//       </CardFooter>
